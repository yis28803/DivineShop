...
Route::middleware('admin')->group(function(){
    ...
    Route::prefix('admin')->group(function () {
        ...
        // Tài Khoàn
        Route::get('/taikhoan', 'App\Http\Controllers\Admin\AdminTaiKhoanController@index')->name("admin.taikhoan.index");
        Route::get('/taikhoan/add', 'App\Http\Controllers\Admin\AdminTaiKhoanController@create')->name('admin.taikhoan.create');
        Route::post('/taikhoan', 'App\Http\Controllers\Admin\AdminTaiKhoanController@store')->name('admin.taikhoan.store');
        Route::get('/taikhoan/edit/{id}', 'App\Http\Controllers\Admin\AdminTaiKhoanController@edit')->name('admin.taikhoan.edit');
        Route::put('/taikhoan/update/{id}', 'App\Http\Controllers\Admin\AdminTaiKhoanController@update')->name('admin.taikhoan.update');
        Route::delete('/taikhoan/delete/{id}', 'App\Http\Controllers\Admin\AdminTaiKhoanController@destroy')->name('admin.taikhoan.destroy');
    });
});
